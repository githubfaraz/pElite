  ...
  return (
    <div className="bg-orange-200 h-max pb-2 pt-2" >
      <div style={{ maxWidth: "1820px", margin: "0 auto" }}>
        <h3 className="mb-6 text-amber-900 text-3xl font-bold text-center pt-4" style={{
          ...
          {products_featured.map((product) => (
            ...
            <Link key={product._id} href={`/products/${product._id}`}>
              <div className="flex flex-col align-middle space-y-3  bg-white w-88 p-5 rounded-md shadow-xl hover:shadow-none hover:cursor-pointer">
                ...
                />
                <hr />
                <h2 className="text-xl font-semibold w-full text-center text-gray-900">{product.name}</h2>
              </div>
            </Link>
          ))}
          {/* <h1 className="rounded-full py-2 px-6 bg-amber-800 text-white w-36">Bully Sticks</h1> */}
        </div>
        <div className="flex flex-row items-center align-middle justify-center mt-8 mb-10 text-centre" >
